...
import { ZoneProfileListViewModel } from 'App/CyberDetection/ZoneProfile/ViewModel/ZoneProfileListViewModel';
...
export class ZoneProfileListView extends BaseGridView<ZoneProfileListViewModel> {

    constructor() {
        super(new ZoneProfileListViewModel());
	}
    ...
    public onGridDataSourceChanged(): void {
        this.setDataSource(this.viewModel.zoneProfileDataSource);
    }

    protected onNavigateTo(e: NavigateToEvent<ZoneProfile>): void {

    }

    protected onCommand(e: CommandEvent<ZoneProfile>): void {

    }

    public static create(): ZoneProfileListView {
        return new ZoneProfileListView();
    }
